...
print(s.isdisjoint(other))  # непересекающийся
s = {'a', 'o'}

print("\n-----x.issubset(other)----------------------------------")
print(s.issubset(other))  # x является подмножеством s

print('--Проверить, каждый ли элемент в множестве состоит из other.---')
print(s <= other)
print('---Проверить, является ли множество правильным подмножеством other, '
...
print("-----Проверить, есть ли в множестве все other элементы----------")
print(s >= other)
print("---Проверить, является ли множество подходящим надмножеством other,"
      " то есть set >= other and set != other.")
print(s > other)
...
print("---Возвращает новое множество с элементами из множества и всеми остальными---")
print(s | other)

print("\n---intersection(*others)-------------------------------------")
print(s.intersection(other))  # пересечение
print("---Возвращает новое множество с элементами, общими для множества и"
      " всех остальных")
print(s & other)

print("\n------ difference(*others)------------------------------------")
print(s.difference(other))
print("----Возвращает новое множество с элементами в множестве, которых нет в других")
print(s - other)

print("\n---symmetric_difference(other)--------------------------")
print(s.symmetric_difference(other))  # симметричная разница
print("---Возвращает новое множество с элементами либо в множестве, либо в other,"
      " но не с обоими.")
print(s ^ other)
