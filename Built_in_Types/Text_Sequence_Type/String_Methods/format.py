...
#  >>>  'The sum of 1 + 2 is 3'
# См. Синтаксис строки формата для описания различных параметров форматирования, которые
# могут быть указаны в строках формата.
# Примечание
# При форматировании числа (int, float, complex, decimal.Decimal и подклассы) с типом n
# (например:
print('{:n}'.format(1234))  # функция временно устанавливает место действия LC_CTYPE
