...
# кода, которому также требуется информация о типе файла или атрибуте файла, поскольку
# объекты os.DirEntry предоставляют эту информацию, если операционная система
...
# close(). Если итератор scandir() не исчерпан и не закрыт явным образом, в его
# деструкторе будет выдано ResourceWarning.
