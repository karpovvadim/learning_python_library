...
"""os.EX_OSFILE"""
# Код выхода, который означает, что какой-то системный файл не существует, не может быть
# открыт или имеет какую-либо другую ошибку.
#       Доступность: Unix, не Emscripten, не WASI.
...
"""os.EX_IOERR"""
# Код выхода, который означает, что произошла ошибка при выполнении
# ввода-вывода в каком-либо файле.
#       Доступность: Unix, не Emscripten, не WASI.
