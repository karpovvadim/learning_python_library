...
import os.path
print(os.path.isabs('/home/vadim/python_library/File_and_Directory_Access/os.path/README.md'))
print(os.path.isabs(b'/home/vadim/python_library/File_and_Directory_Access/os.path/README.md'))
print(os.path.isabs('home/vadim/python_library/File_and_Directory_Access/os.path/getatime.py'))
print(os.path.isabs('../vadim/python_library/File_and_Directory_Access/os.path/README.md'))
