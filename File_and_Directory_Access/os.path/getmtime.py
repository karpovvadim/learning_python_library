...
import os.path
print(os.path.getmtime('/home/vadim/python_library/File_and_Directory_Access/os.path/README.md'))
mtime = os.path.getmtime('/home/vadim/python_library/File_and_Directory_Access/os.path/README.md')
import time
