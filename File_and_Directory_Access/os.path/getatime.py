...
import os.path
import time
print(os.path.getatime('/home/vadim/python_library/File_and_Directory_Access/os.path/note.txt'))
atime = os.path.getatime('/home/vadim/python_library/File_and_Directory_Access/os.path/note.txt')
